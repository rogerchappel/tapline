# Agent Operating Instructions for tapline

This file defines how AI agents and human maintainers should work in `tapline`.

## Project Context

- Project: `tapline`
- Repository: `https://github.com/rogerchappel/tapline`
