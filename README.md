...
Metadata (including derived versions), dependency, and block inspection share
the same boundary for multiline `%q` and `%Q` string bodies, including nested
paired delimiters, while preserving adjacent declarations.
